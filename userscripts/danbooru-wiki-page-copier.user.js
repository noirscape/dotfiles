...
function CreateBooruPage (aEvent) {
    ...
    GM.xmlHttpRequest({"method": "GET",
                       ...
                       "onload": function(response) {
                          ...
                          var url = new URL(`${gmcfg.get('booruDomain')}/wiki_pages/new`);
                          url.search = new URLSearchParams({'wiki_page[title]': jdata.title, 'wiki_page[body]': jdata.body, 'wiki_page[other_names_string]': jdata.other_names.join(' ')});
